...
import type { HeroColumnWithImageReactorTypes } from './HeroColumnWithImageReactor.types';

const HeroColumnWithImageReactor = ({
  heading,
  paragraph,
  cta,
  additionalInfo,
  img,
}: HeroColumnWithImageReactorTypes) => {
  return (
    <section className={styles['HeroColumnWithImageReactor']}>
      <header>
